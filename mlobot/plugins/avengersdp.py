# PLUGINS IMPORTED BY OTHER USERBOT FOR MLOBOT
...
@mlobot.on(admin_cmd(pattern="avengersdp ?(.*)"))
async def main(event):

    await event.edit(
        "**Starting Avengers Profile Pic...\n\nDone !!! Check Your DP in 5 seconds. By your [MLOBOT](https://github.com/prashu32/Mlobot)**"
    )
