...
async def _(event):
    ...
    if input_str == "call":
        ...
        animation_chars = [
            ...
            "`Me: Yo this is` a MlØBOT USER ,`Please Connect me to my lil bro, Pavel Durov`",
            "`User Authorised.`",
            "`Calling Pavel Durov`  `At +916969696969`",
            "`Private  Call Connected...`",
            "`Me: Hello Sir, Please Ban This hutiya Telegram Account.`",
            "`Pavel: May I Know Who Is This?`",
            "`Me: Yo Brah, I Am from ` @SPAMREPORTER FED  ",
