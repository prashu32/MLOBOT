...
@mlobot.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@mlobot.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@mlobot.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@mlobot.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
...
@mlobot.on(admin_cmd(incoming=True))
