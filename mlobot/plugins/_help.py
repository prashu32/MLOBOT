...
@mlobot.on(admin_cmd(pattern="help ?(.*)"))
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f"""`Userbot Helper for {DEFAULTUSER} to reveal all the commands of `**[Mlobot](https://prashu32.gitbook.io/mlobot/)**\n\n"""
            try:
