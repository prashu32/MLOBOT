...
@mlobot.on(admin_cmd(pattern="fstat ?(.*)"))
@mlobot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@mlobot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@mlobot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
