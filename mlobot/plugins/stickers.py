...
KANGING_STR = [
    "Using lipstick to kang this sticker 🤭🤭...",
    "Plagiarising hehe...",
    "Inviting this sticker over to my pack...",
    "Kanging this sticker sir ji...",
    "Hey that's a nice sticker!\nMind if I kang?!..",
    "hehe me stel ur stikér\nhehe.",
    "Udhar Dekh bae(☉｡☉)!→\nWhile I kang this...",
    "Roses are red violets are blue, kanging this sticker by glue😌😌",
    "MILE JO TERE NAINAA HMARE NAINA SE...",
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(
            f"`Sticker kanged successfully by dadagiri!`\
...
async def get_pack_info(event):
    ...
    try:
        ...
        await eor(event, "`This is not a sticker saar. Reply to a sticker.`")
        return
